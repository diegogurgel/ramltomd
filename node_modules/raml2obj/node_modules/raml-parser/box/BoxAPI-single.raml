  ...
  - standardResponse:
      ...
      delete?:
        ...
        responses:
          204:
            description: |
              "No Content. Item successfully removed."
          404:
        ...
        responses:
          200:
            body:
              ...
              example: <<createItemResponseExample>>
  - collectionItem:
      type: standardResponse
      get:
        responses:
          200:
            body:
              schema: <<resourcePathName | !singularize>>
              example: <<itemResponseExample>>
      put:
        body:
          schema: <<resourcePathName | !singularize>>Update
        responses:
          200:
            body:
              schema: <<resourcePathName | !singularize>>
...
traits:
  - fieldAware:
      usage: |
        Adds the `fields` queryParameter. It allows control of the attribute(s) the server
        responds with for the resulting objects.
      queryParameters:
        fields:
  ...
  - pageable:
      usage: |
        Adds the `limits` and `offset` query string parameters that allow clients to regulate how many
        items to return for the request.
      queryParameters:
        limit:
...
/folders:
  type:
    collection: 
      createItemResponseExample: &folderExample |
          {
              "type": "folder",
              "id": "11446498",
              "sequence_id": "1",
  ...
  /{folderId}:
    type:
      collectionItem:
        itemResponseExample: *folderExample
    uriParameters:
      folderId:
        description: |
...
/collaborations:
  type:
    collection: 
      createItemResponseExample: &collaborationExample |
        {
            "type": "collaboration",
            "id": "791293",
            "created_by": {
...
/users:
  type:
    collection: 
      createItemResponseExample: &userExample |
        {
            "type": "user",
            "id": "187273718",
            "name": "Ned Stark",
...
/tasks:
  type:
    collection: 
      createItemResponseExample: &taskExample |
        {
            "type": "task",
            "id": "1839355",
            "item": {
  ...
  /{taskId}:
    type:
      collectionItem: 
        itemResponseExample: *taskExample
    get:
...
/task_assignments:
  type:
    collection: 
      createItemResponseExample: &assignmentExample |
        {
            "type": "task_assignment",
            "id": "2698512",
            "item": {
  ...
  /{task_assignments_id}:
    type:
      collectionItem: 
        itemResponseExample: *assignmentExample
    get:
      description: |
